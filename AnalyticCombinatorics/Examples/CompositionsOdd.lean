...
example : oddCompClass.count 17 = 1597 := by
  rw [show 17 = 16 + 1 by decide, oddCompClass_count_succ_eq_fib]
  decide

example : oddCompClass.count 18 = 2584 := by
  rw [show 18 = 17 + 1 by decide, oddCompClass_count_succ_eq_fib]
  decide

example : oddCompClass.count 19 = 4181 := by
  rw [show 19 = 18 + 1 by decide, oddCompClass_count_succ_eq_fib]
  decide

example : oddCompClass.count 20 = 6765 := by
  rw [show 20 = 19 + 1 by decide, oddCompClass_count_succ_eq_fib]
  decide

example : oddCompClass.count 21 = 10946 := by
  rw [show 21 = 20 + 1 by decide, oddCompClass_count_succ_eq_fib]
  decide

example : oddCompClass.count 22 = 17711 := by
  rw [show 22 = 21 + 1 by decide, oddCompClass_count_succ_eq_fib]
  decide

example : oddCompClass.count 23 = 28657 := by
  rw [show 23 = 22 + 1 by decide, oddCompClass_count_succ_eq_fib]
  decide

example : oddCompClass.count 24 = 46368 := by
  rw [show 24 = 23 + 1 by decide, oddCompClass_count_succ_eq_fib]
  decide

example : oddCompClass.count 25 = 75025 := by
  rw [show 25 = 24 + 1 by decide, oddCompClass_count_succ_eq_fib]
  decide

example : oddCompClass.count 26 = 121393 := by
  rw [show 26 = 25 + 1 by decide, oddCompClass_count_succ_eq_fib]
  decide

example : oddCompClass.count 27 = 196418 := by
  rw [show 27 = 26 + 1 by decide, oddCompClass_count_succ_eq_fib]
  decide
