...
example : labelCycCount Atom 15 = 87178291200 := by
  rw [labelCycCount_Atom_succ]
  decide
example : labelCycCount Atom 16 = 1307674368000 := by
  rw [labelCycCount_Atom_succ]
  decide
example : labelCycCount Atom 17 = 20922789888000 := by
  rw [labelCycCount_Atom_succ]
  decide
example : labelCycCount Atom 18 = 355687428096000 := by
  rw [labelCycCount_Atom_succ]
  decide
example : labelCycCount Atom 19 = 6402373705728000 := by
  rw [labelCycCount_Atom_succ]
  decide
example : labelCycCount Atom 20 = 121645100408832000 := by
  rw [labelCycCount_Atom_succ]
  decide
example : labelCycCount Atom 21 = 2432902008176640000 := by
  rw [labelCycCount_Atom_succ]
  decide
example : labelCycCount Atom 22 = 51090942171709440000 := by
  rw [labelCycCount_Atom_succ]
  decide
example : labelCycCount Atom 23 = 1124000727777607680000 := by
  rw [labelCycCount_Atom_succ]
  decide
