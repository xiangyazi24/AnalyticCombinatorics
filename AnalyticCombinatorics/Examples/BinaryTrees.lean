...
example : BinTree.asClass.count 9 = 4862 := by
  rw [show BinTree.asClass.count 9 = BinTree.catalan 9 from rfl,
      BinTree.catalan_eq_nat_catalan]
  norm_num [_root_.catalan_eq_centralBinom_div, Nat.centralBinom, Nat.choose]

example : BinTree.asClass.count 10 = 16796 := by
  rw [show BinTree.asClass.count 10 = BinTree.catalan 10 from rfl,
      BinTree.catalan_eq_nat_catalan]
  norm_num [_root_.catalan_eq_centralBinom_div, Nat.centralBinom, Nat.choose]

example : BinTree.asClass.count 11 = 58786 := by
  rw [show BinTree.asClass.count 11 = BinTree.catalan 11 from rfl,
      BinTree.catalan_eq_nat_catalan]
  norm_num [_root_.catalan_eq_centralBinom_div, Nat.centralBinom, Nat.choose]

example : BinTree.asClass.count 12 = 208012 := by
  rw [show BinTree.asClass.count 12 = BinTree.catalan 12 from rfl,
      BinTree.catalan_eq_nat_catalan]
  norm_num [_root_.catalan_eq_centralBinom_div, Nat.centralBinom, Nat.choose]

example : BinTree.asClass.count 13 = 742900 := by
  rw [show BinTree.asClass.count 13 = BinTree.catalan 13 from rfl,
      BinTree.catalan_eq_nat_catalan]
  norm_num [_root_.catalan_eq_centralBinom_div, Nat.centralBinom, Nat.choose]

example : BinTree.asClass.count 14 = 2674440 := by
...
example : BinTree.asClass.count 19 = 1767263190 := by
  rw [show BinTree.asClass.count 19 = BinTree.catalan 19 from rfl,
      BinTree.catalan_eq_nat_catalan]
  rw [_root_.catalan_eq_centralBinom_div]
  native_decide

example : BinTree.asClass.count 20 = 6564120420 := by
  rw [show BinTree.asClass.count 20 = BinTree.catalan 20 from rfl,
      BinTree.catalan_eq_nat_catalan]
  rw [_root_.catalan_eq_centralBinom_div]
  native_decide

example : BinTree.asClass.count 21 = 24466267020 := by
  rw [show BinTree.asClass.count 21 = BinTree.catalan 21 from rfl,
      BinTree.catalan_eq_nat_catalan]
  rw [_root_.catalan_eq_centralBinom_div]
  native_decide

example : BinTree.asClass.count 22 = 91482563640 := by
  rw [show BinTree.asClass.count 22 = BinTree.catalan 22 from rfl,
      BinTree.catalan_eq_nat_catalan]
  rw [_root_.catalan_eq_centralBinom_div]
  native_decide

example : BinTree.asClass.count 23 = 343059613650 := by
  rw [show BinTree.asClass.count 23 = BinTree.catalan 23 from rfl,
      BinTree.catalan_eq_nat_catalan]
  rw [_root_.catalan_eq_centralBinom_div]
  native_decide

example : BinTree.asClass.count 24 = 1289904147324 := by
  rw [show BinTree.asClass.count 24 = BinTree.catalan 24 from rfl,
      BinTree.catalan_eq_nat_catalan]
  rw [_root_.catalan_eq_centralBinom_div]
  native_decide
